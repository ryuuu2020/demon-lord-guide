export const metadata = {
  title: "Demon Lord PRIVACY POLICY — Complete Guide (2026)",
  description:
    "Demon Lord Guide uses Google Analytics to collect anonymized visit statistics (page views, referral channels, etc.) for content optimization. Google Analytics uses anonymized client IDs and does not c...",
};
        ...
        <div className="border border-border-gold p-6 lg:p-8 bg-abyss-elevated space-y-6">
          <section>
            ...
            <p className="font-body text-sm text-parchment-dim leading-relaxed">
              Demon Lord Guide uses Google Analytics to collect anonymized visit statistics (page views, referral channels, etc.) for content optimization. Google Analytics uses anonymized client IDs and does not collect personal identity information.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="font-body text-sm text-parchment-dim leading-relaxed">
              This site has no affiliation with YuWave studio, the developer of Demon Lord: Just a Block. Game strategy data is sourced from community resources. This is an unofficial independent fan site.
            </p>
          </section>
        </div>
      </div>
